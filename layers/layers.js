...
lyr_LimiteProvincial_3.set('fieldAliases', {'IDDPTO': 'IDDPTO', 'DEPARTAMEN': 'DEPARTAMEN', 'PROVINCIA': 'PROVINCIA', 'CAPITAL': 'CAPITAL', 'OAM': 'OAM', 'ELEGIBLES': 'ELEGIBLES', 'NO ELEGIBL': 'NO ELEGIBL', });
...
lyr_Distritos_6.set('fieldAliases', {'CATEGORIA': 'CATEGORIA', 'NOMBRE': 'NOMBRE', 'DISTRITO': 'DISTRITO', 'DEPARTA': 'DEPARTA', 'EEMRI': 'SOLICITUDES EEMRI', 'participa': 'PARTICIPA EEMRI', 'ELEGIBLES': 'ELEGIBLES', 'NO ELEGIBL': 'NO ELEGIBLES', });
...
lyr_LimiteProvincial_3.set('fieldImages', {'IDDPTO': 'TextEdit', 'DEPARTAMEN': 'TextEdit', 'PROVINCIA': 'TextEdit', 'CAPITAL': 'TextEdit', 'OAM': 'TextEdit', 'ELEGIBLES': '', 'NO ELEGIBL': '', });
...
lyr_Distritos_6.set('fieldImages', {'CATEGORIA': 'TextEdit', 'NOMBRE': 'TextEdit', 'DISTRITO': 'TextEdit', 'DEPARTA': 'TextEdit', 'EEMRI': 'TextEdit', 'participa': 'TextEdit', 'ELEGIBLES': 'Range', 'NO ELEGIBL': 'Range', });
...
lyr_LimiteProvincial_3.set('fieldLabels', {'IDDPTO': 'no label', 'DEPARTAMEN': 'no label', 'PROVINCIA': 'no label', 'CAPITAL': 'no label', 'OAM': 'no label', 'ELEGIBLES': 'no label', 'NO ELEGIBL': 'no label', });
...
lyr_Distritos_6.set('fieldLabels', {'CATEGORIA': 'hidden field', 'NOMBRE': 'hidden field', 'DISTRITO': 'inline label - always visible', 'DEPARTA': 'hidden field', 'EEMRI': 'inline label - always visible', 'participa': 'hidden field', 'ELEGIBLES': 'inline label - always visible', 'NO ELEGIBL': 'inline label - always visible', });
